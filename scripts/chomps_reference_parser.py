...
def parse_chomps_domain_scores_simple(report_data: dict) -> list:
    ...
    """
    domain_scores = []
    chomps_data = report_data['scores']['chomps']['observationsByCategory']
...
if __name__ == "__main__":
    ...
    with open("/home/lap-49/Documents/ot-report/outputs/report_data_3e255a02-5b7d-4a05-b2fb-4e77820e45c8.json", 'r') as f:
        report_data_file = json.loads(f.read())
    
    # Example domain scores (from your previous data)
    # example_scores = [
    #     {'domain_name': 'COMPLEX MOVEMENT PATTERNS', 'total_score': 15},
    #     {'domain_name': 'BASIC MOVEMENT PATTERNS', 'total_score': 36},
    #     {'domain_name': 'ORAL-MOTOR COORDINATION', 'total_score': 8},
    #     {'domain_name': 'FUNDAMENTAL ORAL-MOTOR SKILLS', 'total_score': 6}
    # ]

    example_scores = parse_chomps_domain_scores_simple(report_data_file)
