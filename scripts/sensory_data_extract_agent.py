...
extraction_prompt_template = ChatPromptTemplate.from_messages([
    ("system", """You are an expert pediatric occupational therapist analyzing a Toddler Sensory Profile™ 2 Summary Report. 
    You have extensive experience with sensory processing assessments and understand the clinical significance of each section.
    Extract information with precision and maintain clinical accuracy. ALWAYS return valid JSON that can be parsed directly."""),
    ("human", """{prompt}
...
{{
  ...
  "processing": {{
    "GENERAL": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }},
    "AUDITORY": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }},
    "VISUAL": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }},
    "TOUCH": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }},
    "MOVEMENT": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }},
    "ORAL_SENSORY": {{ "items": [{{ "item_no": "0", "item_description": "description of item", "score": "score" }}], "raw_score": null }}
  }},
...
def parse_sensory_data(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        prompt = f"""
        Extract the following information from this Toddler Sensory Profile™ 2 Summary Report:

        1. Individual item scores and raw scores for each processing area
        2. Quadrant score summary with raw scores, percentile ranges, and classifications
        3. Sensory and behavioral section score summary with raw scores, percentile ranges, and classifications
