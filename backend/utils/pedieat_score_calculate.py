...
def _parse_pedieat_domain_scores(pedieat_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    """
    ...
    for domain_key, domain_data in pedieat_data.items():
        ...
        domain_scores.append({
            "domain_name": formatted_domain_name,
            "score": total_score,
            "asc_score": asc_score,
...
def evaluate_pedieat_by_age(pedieat_data: Dict[str, Any], child_age_months: int) -> List[Dict[str, Any]]:
    ...
    Returns:
        list: List of dictionaries with keys "domain_name", 'score', 'status'
    """
    ...
    domain_scores = _parse_pedieat_domain_scores(pedieat_data)
...
def parse_pedieat_domain_scores(report_data):
    ...
    try:
        ...
        for result in results:
            print(f"  • {result['domain_name']}: {result['score']} → {result['status']}")
