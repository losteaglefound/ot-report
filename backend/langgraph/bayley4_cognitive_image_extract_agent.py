...
def find_subtest_scaled_and_standard_score(state: State):
    ...
    """
    print("Starting searching for bayley4 cognitive score table")
...
def bayley4_cognitive_image_extract(pdf_path):
    """
    Extract bayley4_cognitive profile images from PDF and return ReportLab elements
    ...
    initial_state = State(
        ...
        found_pages=[],
        error=None,
        out_path='outputs/test_bayley4_cognitive_score_extract.pdf'
    )
